...
module.exports = function(geocoder, query, options, callback) {
    ...
    if (options.types) {
        ...
        var landmarkPosInTypes = options.types.indexOf('landmark');
        if (landmarkPosInTypes > -1) {
            options.landmark = true;
            (options.types.indexOf('poi') > -1) ? options.types.splice(landmarkPosInTypes, 1) : options.types.splice(landmarkPosInTypes, 1, 'poi');
        }
